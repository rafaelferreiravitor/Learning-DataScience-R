...
library(ggplot2)
ggplot() + geom_point(aes(x = base$idade, y = base$custo), colour = 'blue') + geom_line (aes(x=base$idade,y=predict(regressor1,newdata = base[-2]), colour = 'red'))
...
library(ggplot2)
ggplot() + geom_point(aes(x = base$idade, y = base$custo), colour = 'blue') + geom_line (aes(x=base$idade,y=predict(regressor2,newdata = base2[-2]), colour = 'red'))
