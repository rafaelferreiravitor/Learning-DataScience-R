...
#Convertendo o tipo de dados para o tipo tipo necessario para o algoritmo(dataframe->decision table)
...
#discretização dos atributos para transformalos em string ()
